...
export default class ApiManager {
	...
	public async getCssFromFile(cssfilename: string): Promise<string> {
	...
	async newDraftToWechat(
		...
		try {
			...
			let htmlText = await marked.parse(MdImagedContent);
			htmlText = processCode(htmlText);
			console.log("formatCodeHTML", htmlText);
			...
			console.log("solveHTML", htmlText);
			// return;
